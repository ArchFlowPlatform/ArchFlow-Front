...
export default function ConfirmDialog({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 px-4 py-6 backdrop-blur-[2px]">
      <div className="af-surface-lg w-full max-w-md bg-[#14121a]/96 px-5 py-5">
